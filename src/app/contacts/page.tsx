...
const ContactPage = () => {
  ...
  return (
    <motion.div className="container max-w-7xl mx-auto py-20" variants={staggerContainer} initial="initial" animate="animate">
      <motion.h1 className="text-4xl font-bold mb-20 text-center" variants={fadeInUp}>Contact Me</motion.h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <motion.div className="space-y-8" variants={fadeInUp}>
          ...
          <p className="text-secondary md:2-2/3"> I'm always open to discussing new projects, creative ideas, or
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <Link href="mailto:honoriorojas055@gmail.com" className="text-secondary hover:text-primary">honoriorojas055@gmail.com</Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <Link href="tel:+639663127526" className="text-secondary hover:text-primary">+639663127526</Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-secondary hover:text-primary">Cavite City, Philippines</p>
              </div>
            </div>
          </div>
        </motion.div>
